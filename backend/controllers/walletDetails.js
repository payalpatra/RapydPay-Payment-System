...
module.exports = function (req, res) {
    let clickedWallet = req.body;
    body = ""

    // Request Data Parameters
    const uri = `https://sandboxapi.rapyd.net/v1/ewallets/${clickedWallet.ewallet_id}/contacts`;
    const http_method = 'get'
    const path = `/v1/ewallets/${clickedWallet.ewallet_id}/contacts`
    ...
    request(requestData, function (err, res, body) {
        ...
        console.log(response.data[0].ewallet)
    })
