...
function PaymentInfo({ paymentId, customerId, amount, ewallet_id, created_at }) {
            ...
            <ProductsCardInfo>
                ...
                <ProductsCardFeatures style={{ marginTop: "5px", marginBottom: "20px" }}>
                    {clickedWallet.customer.ewallet_id === ewallet_id ?
                        <ProductsCardFeature style={{ fontSize: "17px", color: "#228B22" }}>Paid To: {ewallet_id.slice(8)}</ProductsCardFeature> :
                        <ProductsCardFeature style={{ fontSize: "17px", color: "#EE4B2B" }}>Paid To: {ewallet_id.slice(8)}</ProductsCardFeature>
                    }
